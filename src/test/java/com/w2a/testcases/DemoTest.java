...
//        WebElement element = driver.findElement(By.cssSelector("[class='username username-hide-on-mobile ng-binding']"));
//        element.click();
//        element = driver.findElement(By.cssSelector("[href='#/auth']"));
//        element.click();
          driver.close();
    }
